...
- **Download close and footer:** centered-max-width CTA, then a hairline-topped footer with a center-justified wordmark.
...
### Primary Button
Filled cobalt, white text, 16px/24px padding, 6px radius, sentence case — never uppercase. Hover deepens to `#1749a6` and lifts 1px; focus shows a 2px cobalt ring with 3px offset. A trailing `→` in mono is part of the mark.
