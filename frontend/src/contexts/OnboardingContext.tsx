...
export function OnboardingProvider({ children }: { children: React.ReactNode }) {
  ...
  const initializeDatabaseInBackground = async () => {
    try {
      ...
      // First launch - always initialize a fresh Sivlo database.
      // Legacy Meetily data is intentionally NOT auto-imported; explicit legacy
      // import remains available through the DatabaseImport components/commands.
