      ...
      const toastId = toast.info('Recording Started', {
        description: (
          <div className="space-y-3 min-w-[280px]">
            ...
            <label className="flex items-center gap-2 text-xs cursor-pointer hover:bg-surface-subtle p-2 rounded transition-colors">
              <input
                type="checkbox"
                onChange={(e) => {
            ...
            <button
              ...
              className="w-full px-3 py-1.5 bg-primary text-primary-foreground text-xs rounded hover:opacity-90 transition-colors font-medium"
            >
