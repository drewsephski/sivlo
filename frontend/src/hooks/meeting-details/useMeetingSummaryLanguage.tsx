...
/**
 * Per-meeting summary language selection, extracted from SummaryPanel so the
 * language picker can be shared across summary surfaces (legacy panel and the
 * new Meeting Intelligence Summary view).
 *
 * Persistence uses a versioned save-loop: rapid language switches are
 * coalesced so only the latest selection is written, with rollback on failure.
 */
...
export function useMeetingSummaryLanguage(meetingId: string): {
  ...
  return { languageSlot, summaryLang };
}
